...
package org.ruboss.events {
  ...
  /**
   * This event is dispatched when a Ruboss Model changes state because
   * data is being loaded from the server
   */
  public class ModelStateChangeEvent extends Event {
    
    /** Event identifier */
    public static var ID:String = "modelStateChange";
    
    /** Fully qualified name of the model class that got updated */
    public var newState:String;
    
    public function ModelStateChangeEvent(state:String) {
